...
public class AutoSuggestor {
    ...
    public AutoSuggestor(JTextField textField, Window mainWindow, Set<String> words, Color popUpBackground, Color textColor, Color suggestionFocusedColor, float opacity) {
    ...
    private void showPopUpWindow() {
        ...
        int windowX = 0;
        int windowY = 0;
        windowX = container.getX() + textField.getX() + 13;
        ...
        autoSuggestionPopUpWindow.setMinimumSize(new Dimension(textField.getWidth(), 20));
